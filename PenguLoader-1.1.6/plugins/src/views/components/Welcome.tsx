    ...
    (t) => {
      return (
        <div
          class={`${
            !t.visible && "hidden"
          } relative w-[370px] bg-white shadow-lg rounded-lg pointer-events-auto ring-1 ring-black ring-opacity-5 overflow-hidden`}
        >
          <div class="p-2">
            <div class="flex items-start">
              ...
              <div class="ml-3 w-0 flex-1 pt-0.5">
                <p class="text-sm font-bold text-sky-500">
                  {_t("update_available")} - {update.version}
                </p>
...
export function Welcome() {
  const welcome =
    window.DataStore?.get<boolean>("pengu-welcome", true) !== false;
